export default {
  ...
  login: {
    ...
    notice: `music hesabınızın hiçbir bilgisini kaydetmeyeceğine dair söz veriyor<br />
      ...
      music, NetEase Music'in resmi websitesi değildir, lütfen hesap bilgilerinizi girmeden önce dikkatlice düşününüz. Aynı zamanda, Kendi NetEase Musix API'nızı host etmek için <a href="https://github.com/qier222/music">music'in  Repo'suna</a> gidebilirsiniz.`,
